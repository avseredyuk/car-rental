...
public class CommandGetOrder implements Command {
    ...
    public CommandResult execute(RequestWrapper req) {
        ...
        try {
            ...
            return CommandFactory.getInstance().getByName(ConstantClass.COMMAND_GET_ALL_ORDERS).execute(req);
        }
        return new CommandResult(ConfigurationManager.getProperty("path.page.getorder"),

...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_DELETE_AUTOMOBILE;
 ...
 */
public class CommandDeleteAutomobileTest extends Utils {
    ...
    Command command = CommandFactory.getInstance().getByName(COMMAND_DELETE_AUTOMOBILE);

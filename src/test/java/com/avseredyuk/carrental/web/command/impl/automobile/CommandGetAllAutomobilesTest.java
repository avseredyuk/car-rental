...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_GET_ALL_AUTOMOBILES;
 ...
 */
public class CommandGetAllAutomobilesTest extends Utils {
    RequestWrapper req = mock(RequestWrapper.class);
    SessionWrapper session = mock(SessionWrapper.class);
    Command command = CommandFactory.getInstance().getByName(COMMAND_GET_ALL_AUTOMOBILES);

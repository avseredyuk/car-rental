...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_DELETE_ORDER;
 ...
 */
public class CommandDeleteOrderTest extends Utils {
    ...
    Command command = CommandFactory.getInstance().getByName(COMMAND_DELETE_ORDER);

...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_EDIT_ORDER;
 ...
 */
public class CommandEditOrderTest extends Utils {
    ...
    Command command = CommandFactory.getInstance().getByName(COMMAND_EDIT_ORDER);

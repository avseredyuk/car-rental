...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_CREATE_PLACE;
 ...
 */
public class CommandCreatePlaceTest extends Utils {
    ...
    Command command = CommandFactory.getInstance().getByName(COMMAND_CREATE_PLACE);

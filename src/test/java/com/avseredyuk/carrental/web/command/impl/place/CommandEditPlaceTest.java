...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_EDIT_PLACE;
 ...
 */
public class CommandEditPlaceTest extends Utils {
    RequestWrapper req = mock(RequestWrapper.class);
    SessionWrapper session = mock(SessionWrapper.class);
    Command command = CommandFactory.getInstance().getByName(COMMAND_EDIT_PLACE);

...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_GET_ALL_PLACES;
 ...
 */
public class CommandGetAllPlacesTest extends Utils {
    ...
    Command command = CommandFactory.getInstance().getByName(COMMAND_GET_ALL_PLACES);

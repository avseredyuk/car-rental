...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_GET_PLACE;
 ...
 */
public class CommandGetPlaceTest extends Utils {
    ...
    Command command = CommandFactory.getInstance().getByName(COMMAND_GET_PLACE);

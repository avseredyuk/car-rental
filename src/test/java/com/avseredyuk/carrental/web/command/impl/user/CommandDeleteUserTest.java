...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_DELETE_USER;
 ...
 */
public class CommandDeleteUserTest extends Utils {
    RequestWrapper req = mock(RequestWrapper.class);
    SessionWrapper session = mock(SessionWrapper.class);
    Command command = CommandFactory.getInstance().getByName(COMMAND_DELETE_USER);

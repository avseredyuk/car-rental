...
import static com.avseredyuk.carrental.web.util.ConstantClass.COMMAND_GET_USER;
 ...
 */
public class CommandGetUserTest extends Utils {
    ...
    Command command = CommandFactory.getInstance().getByName(COMMAND_GET_USER);
